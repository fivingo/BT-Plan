...
public class ImageBbsListPager 
{
	...
	public ImageBbsListPager(ImageBbsDAO bbsDao, int listPerPage, int pagePerGroup) {
		super();
		this.bbsDao = bbsDao;
	...
	public void preProcess(String crp)
	{
		...
		//#2.Get info from DB.!
			...
			lists=bbsDao.bbsList(userCurrentPage, listPerPage);
	}
}
